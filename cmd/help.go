...
func printCheatSheet(w io.Writer) {
	...
	entry(w, "saber scoring rule upsert <profileId> --signal-template <id> --dimension <fit|urgency> ...", "Create or replace a rule (triggers recompute)")
	...
	fmt.Fprintln(w)
	fmt.Fprintln(w, "  Rule point values (provide exactly one shape):")
